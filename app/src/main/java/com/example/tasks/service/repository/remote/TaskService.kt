...
interface TaskService {
    ...
    @GET("Task/{id}") //encode = true -> tira espaco entre palavras. EX: matheus olha - ficando matheusolha
    ...
    @HTTP(method = "PUT", path = "Task", hasBody = true) //hasBody é igual a true pq passa um ID
    @FormUrlEncoded
    fun update(
        @Field("Id") id: Int,
        @Field("PriorityId") priorityId: Int,
